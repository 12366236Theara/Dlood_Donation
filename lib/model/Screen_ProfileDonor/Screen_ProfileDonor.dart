...
import 'package:kilo_health/model/Screen_ProfileDonor/conpoment/Cartse.dart';
import 'package:kilo_health/model/Screen_ProfileDonor/conpoment/Property_Call.dart';
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                PropertyCall(Icons.call, "Call Now", Colors.blue),
                PropertyCall(
                    Icons.group_remove_rounded, " Request", Colors.red),
              ],
            ),
            const SizedBox(
              height: 40,
